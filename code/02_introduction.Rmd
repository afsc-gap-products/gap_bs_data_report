...
In `r maxyr`, the RACE Division of NMFS' AFSC conducted `r text_list(paste0('the ',haul_cruises_maxyr$yrofsurvey ,haul_cruises_maxyr$stndth, ' "',haul_cruises_maxyr$SRVY,'" (',haul_cruises_maxyr$SRVY,') shelf survey'))`. `r insert2` `r insert`
