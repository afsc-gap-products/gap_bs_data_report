...
height <- 3.2 # full_page_portrait_height-2.5
width <- full_page_portrait_width
...
figure_print <- cowplot::ggdraw(figure_print) +
  cowplot::draw_label("A", x = 0.00, y = 0.95, hjust = 0, vjust = 0, size = 16) +
...
if (exists("comm_size")) {
figure_print <- cowplot::ggdraw(figure_print) +
  cowplot::draw_label("B", x = 0.6, y = 0.95, hjust = 0, vjust = 0, size = 16)
}
...
header <- paste0(
  ...
  ". (",ifelse((exists("comm_size")), "C", "B"),") Biomass timeseries during the ",
  substr(x = gsub("[^0-9]", "", pres_timeseries_txt), start = 1, stop = 4),"-2025 ", # SURVEY,
  "survey",plural_surveys," (points and solid lines, with estimated 95% confidence intervals error bars) and timeseries mean (dashed lines). ",
