...
for (i in 1:nrow(comb)) {
  ...
  table_print <- table_raw1 %>% 
    ...
    flextable::width(width = (pgwidth-1-.25-.1-1-1)/(length(strat)+2), 
                     unit = "in") %>%
...
for (i in 1:2) {
  ...
  if (i == 1){ # CPUE (WT/km²) and BIOMASS
    ...
    header <- paste0("Total mean weight CPUE (kg/km²) with standard deviation (SD; kg/km²), estimated biomass (t) with SD (t), and number of hauls where weights where species were weighed for common groundfish species by survey region during the ",
    ...
    header <- paste0("Total mean count CPUE (no/km²) with standard deviation (SD; kg/km²), estimated biomass (t) with SD (t), and number of hauls where species were counted for common groundfish species by survey region during the ",
                     maxyr," ", text_list(paste0(haul_cruises_maxyr$SRVY_long, 
                                                 " (", haul_cruises_maxyr$SRVY, "; ", 
                                                 haul_cruises_maxyr$stations_completed, " stations completed)")), 
                     " shelf bottom trawl survey",plural_surveys,".")
    ...
    table_raw <- temp %>% 
      dplyr::select(print_name, SRVY, 
                    cpue_nokm2_mean, cpue_nokm2_sd, 
                    population_count, population_sd, n_count)
