...
temp <- readr::read_csv(paste0(dir_out_rawdata, "/0_special_projects.csv"))
...
header <- paste0("Cold pool extent in the eastern Bering Sea (EBS), as measured using observations from the EBS bottom trawl survey. Extent of the cold pool in proportion to the total EBS shelf survey area from 1982–",maxyr,". Shading denotes bottom temperatures ≤ 2°C, ≤ 1°C, ≤ 0°C, and ≤ -1°C.")
...
figure <- 
  cowplot::ggdraw() +
  cowplot::draw_image(readPNG(paste0(dir_img, "stacked_temperature.png")) )
