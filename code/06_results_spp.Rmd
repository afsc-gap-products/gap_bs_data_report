...
```{r spp_text-{{jj}}, child=paste0(dir_out_rawdata, spp_file, ,".Rmd")}
```

```{r fig-idw-cpue-{{jj}}}
nickname <- paste0("fig-idw-cpue-*", spp_file)
```

```{r fig-idw-cpue-{{jj}}-child, child = paste0(dir_code, "_child_report_figtab.Rmd")}
```
...
```{r fig-sizecomp-{{jj}}, child = paste0(dir_code, "_child_report_figtab.Rmd")}
```

`r land_start `

```{r tab-estimates-maxyr-{{jj}}}
nickname <- paste0("tab-estimates-maxyr-", spp_file)
```

```{r tab-estimates-maxyr-{{jj}}, child = paste0(dir_code, "_child_report_figtab.Rmd")}
```
