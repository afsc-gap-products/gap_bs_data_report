...
Detailed information on bottom trawl survey results for commercial crab species stocks, including Tanner crab (*Chionoecetes bairdi*), snow crab (*Chionoecetes opilio*), red king crab (*Paralithodes camtschaticus*), blue king crab (*Paralithodes platypus*), and hair crab (*Erimacrus isenbeckii*), are discussed and analyzed separately in the AFSC Shellfish Assessment Program's annual data report [@SAPcrab`r maxyr`]. Commercial crab stocks are managed by the ADF&G with federal oversight by NMFS. The most recent modeling results on the status of these commercial crab stocks are reported in the annual Stock Assessment and Fishery Evaluation report prepared by the NPFMC [@NPFMC]. 

This technical memorandum compares results from the `r maxyr` survey with results from the prior year's survey`r plural_surveys` in the same region`r plural_surveys` [`r ref_compareyr`]. Specifically, `r text_list(paste0("the ", maxyr, " ", SRVY11, " survey results are compared with those from the ", compareyr, " ", SRVY11, " shelf bottom trawl survey"))`.  Technical memoranda reporting past survey data can be found on the NOAA ([https://repository.library.noaa.gov/](https://repository.library.noaa.gov/)) and AFSC websites ( [https://www.fisheries.noaa.gov/resource/publication-database/alaska-fisheries-science-center-technical-memorandums](https://www.fisheries.noaa.gov/resource/publication-database/alaska-fisheries-science-center-technical-memorandums) and [https://www.fisheries.noaa.gov/alaska/science-data/groundfish-assessment-program-bottom-trawl-surveys](https://www.fisheries.noaa.gov/alaska/science-data/groundfish-assessment-program-bottom-trawl-surveys)).
