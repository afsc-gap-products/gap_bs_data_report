...
header <- paste0("Summary ranges of biomass, population, and environmental variables in which ", 
                 spp_print, " (", spp_sci, ") have been found across the ", 
    ...
    if (i == 1) { # CPUE (WT/km²) and BIOMASS
      ...
      if (nrow(table_raw) != 0) { # if none were caught, don't do any of this
        ...
        table_print <- table_print0 %>% 
          ...
          flextable::set_header_labels(
            x = ., 
            cpue_kgkm2_mean = paste0("Mean CPUE", ifelse(cpue_kgkm2_mean0$unit_wrd=="", "", paste0("\n",cpue_kgkm2_mean0$unit_wrd))), 
            cpue_kgkm2_sd = paste0("SD CPUE", ifelse(cpue_kgkm2_sd0$unit_wrd=="", "", paste0("\n",cpue_kgkm2_sd0$unit_wrd))), 
            biomass_mt = paste0("Estimated biomass", ifelse(biomass_mt0$unit_wrd=="", "", paste0("\n",biomass_mt0$unit_wrd))), 
            biomass_sd = paste0("SD biomass", ifelse(biomass_sd0$unit_wrd=="", "", paste0("\n",biomass_sd0$unit_wrd))), 
      ...
      if (nrow(table_raw) != 0) { # if none were caught, don't do any of this
        ...
        table_print <- table_print0 %>% 
          ...
          flextable::set_header_labels(
            x = ., 
            cpue_nokm2_mean = paste0("Mean CPUE", ifelse(cpue_nokm2_mean0$unit_wrd=="", "", paste0("\n", cpue_nokm2_mean0$unit_wrd))), 
            cpue_nokm2_sd = paste0("SD CPUE", ifelse(cpue_nokm2_sd0$unit_wrd=="", "", paste0("\n", cpue_nokm2_sd0$unit_wrd))), 
            population_count = paste0("Estimated Population", 
                                      ifelse(population_count0$unit_wrd=="", "", paste0("\n", population_count0$unit_wrd))),
            population_sd = paste0("SD Population", ifelse(population_sd0$unit_wrd=="", "", paste0("\n", population_sd0$unit_wrd))), 
