      ...
      if (nrow(table_raw) != 0) { # if none were caught, don't do any of this
        ...
        table_print <- table_print0 %>% 
          ...
          flextable::set_header_labels(
            ...
            biomass_dw = paste0("95% LCL", ifelse(biomass_mt0$unit_word=="", "", paste0("\n",biomass_mt0$unit_word))),
            biomass_up = paste0("95% UCL", ifelse(biomass_mt0$unit_word=="", "", paste0("\n",biomass_mt0$unit_word)))
          ) 
      }
      ...
      if (nrow(table_raw) != 0) { # if none were caught, don't do any of this
        ...
        table_print <- table_print0 %>% 
          ...
          flextable::set_header_labels(
            ...
            population_dw = paste0("95% LCL", ifelse(population_count0$unit_word=="", "", paste0("\n", population_count0$unit_word))),
            population_up = paste0("95% UCL", ifelse(population_count0$unit_word=="", "", paste0("\n", population_count0$unit_word)))
          ) 
      }
