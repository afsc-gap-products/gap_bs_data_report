...
if ((temp0$warmest_rank > (nrow(temps_avg_yr)-6)) |  (temp0$warmest_rank < 6)) {
  ...
  str0 <- paste0(str0, 
                 " observed since the beginning of the eastern Bering Sea shelf bottom trawl survey time series in 1982. ")
}
...
for (i in 1:length(SRVY1)){
  ...
  str00 <- paste0(str00, 
    ...
    ifelse(plural_surveys == "", "", paste0(" in the ", srvy1)),
    " was ",
    xunits(temp_max), " ",
...
str0_biomass <- paste0(
  ...
  ifelse(plural_surveys == "", "", paste0(" ", SURVEY)), 
