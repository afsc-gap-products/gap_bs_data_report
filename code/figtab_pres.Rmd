...
## fig_bottom_temperature

```{r fig_bt_all_nebs_surveys}
nickname <- "fig_bottom_temperature"
height <- 4
width <- 9
...
nickname <- "fig_surface_temperature"
...
temp11 <- function(a, dat0, y_long, unit, unt, yrs, y, maxyr, 
  ...
  table_raw <- b$table_raw %>% 
    dplyr::select(Survey, print_name, as.character(compareyr), dplyr::ends_with(as.character(maxyr))) %>% 
