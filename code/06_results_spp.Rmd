...
temp<-species_content(
  ...
  # figures = list("biomass_cpue_tab_name" = biomass_cpue_tab_name, 
  #                "fig_dist" = fig_dist, 
  #                "fig_sizecomp" = fig_sizecomp, 
  #                "tab_wt" = tab_wt, 
  #                "tab_no" = tab_no), 
...
```{r fig-dist-{{jj}}-child, child = paste0(dir_code, "_child_report_figtab.Rmd"), eval=ifelse(spp_plot_idw, TRUE, FALSE)}
```
