  ...
  figure_print <- ggplot2::ggplot(
    ...
    # ggplot2::scale_fill_viridis_d(option = "G", begin = .3, end = .7) +
          ggplot2::scale_fill_viridis_d(direction = -1,
                                    ...
                                    drop = FALSE) +
    ggplot2::scale_y_continuous(name = "Age bin", 
                                label = abs, 
                       breaks = function(age) unique(floor(pretty(seq(-(max(age) + 1) * 1.1, 
                                                                      (max(age) + 1) * 1.1))))) +
    ggplot2::scale_x_continuous(name = paste0(#spp_print, " ",
...
yrs <- yrs_age <- head(sort((unique(agecomp0$year)), decreasing = TRUE), 3)
...
figure_print <- cowplot::ggdraw(figure_print) +
    cowplot::draw_label("D", x = 0.81, y = 0.94, hjust = 0, vjust = 0, size = 16)
