...
if (text_spp) {
  ...
  figure_coldpool_warm_stanza <- NMFSReports::crossref(
    list_obj = list_figure, 
    nickname = paste0("fig_bt_timeseries_above"), 
    sublist = "number", 
    exact = FALSE)
  figure_coldpool_cold_stanza <- NMFSReports::crossref(
    list_obj = list_tables, 
    nickname = paste0("fig_bt_timeseries_below"), 
    sublist = "number")
  figure_coldpool_both_stanza <- NMFSReports::crossref(
    list_obj = list_tables, 
    nickname = paste0("fig_bt_timeseries_*"), 
    sublist = "number", 
    exact = FALSE)
  ...
  table_est_both <- NMFSReports::crossref(
    list_obj = list_tables, 
    nickname = paste0("tab_estimates_maxyr_fish_", spp_file, "*"), 
    sublist = "number", 
    exact = FALSE)
  table_est_wt <- NMFSReports::crossref(
    list_obj = list_tables, 
    nickname = paste0("tab_estimates_maxyr_fish_", spp_file, "_wt"), 
    sublist = "number")
  table_est_num <- NMFSReports::crossref(
    list_obj = list_tables, 
    nickname = paste0("tab_estimates_maxyr_fish_", spp_file, "_num"), 
    sublist = "number")
  ...
  if (plot_idw_coldwarm) {
      figure_idw_both_stanza <- NMFSReports::crossref(
        list_obj = list_figures, 
        nickname = paste0("fig_idw_cpue_fish_", spp_file, "*"), sublist = "number")
...
`r NMFSReports::crossref(list_obj = list_figures, nickname = paste0("tab_estimates_maxyr_*_", spp_file, "*"), sublist = "res", exact = FALSE)`
