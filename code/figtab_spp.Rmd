...
header <- paste0("Summary ranges of biomass, population, and environmental variables in which ", 
                 spp_print, " (", spp_sci, ") were found in the ", 
...
table_print0 <- data.frame("var" = rownames(t(table_raw))[-1], 
                          data.frame(t(table_raw)[-1,]))  
names(table_print0) <- c("var", stringr::str_to_title(SRVY11))
