...
for (case in c("bottom", "surface")) {
  ...
  title0 = paste0("Eastern", ifelse(SRVY == "NEBS", " and northern", ""), 
                  " Bering Sea\n", 
                  case, " temperature (", range_text(yrs), ")") # - ", viridis0)
  
  figure <- plot_temperature_facet(
    # viridis_palette_option = viridis0, 
  ...
  #   print(nickname)
  #   ggsave(filename = paste0(getwd(), "/", nickname, "-", viridis0, ".png"), plot = figure, height = height, width = width, bg = "white")
  #   
  #   
  # }
}
