...
if ("EBS" %in% temp$srvy) {
  ...
  case <- dplyr::case_when(
    ...
    temp0$catch_min < 100 ~ 
      paste0(tolower(strsplit(x = temp0$`Observed Catch Totals`, split = " ", fixed = TRUE)[[1]][1]), 
             " to ", temp0$`Biomass`, ", extrapolated from ", 
  ...
  str0 <- paste0(str0, 
                 case, 
                 " in the eastern Bering Sea survey from ", 
...
if ("NBS" %in% temp$srvy) {
  ...
  str0 <- paste0(str0, str0_transition, 
                 "biomass estimate in the northern Bering Sea survey ", case,  
...
str0 <- paste0(str0, 
                 ifelse(
                   ...
                   paste0(spp_print, " lengths are not collected during the eastern and northern Bering Sea surveys. "), 
                   "") )  
  
str0 <- paste0(str0, 
                 ifelse((spp_print == "tunicates"), "No population estimate is calculated because this organism is colonial and it is not possible to count individuals. ", "") )
