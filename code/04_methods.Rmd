...
The standardized eastern Bering Sea survey consists of a systematic design with 350 fixed sampling stations arranged on a regularly spaced 37.04 × 37.04 km grid (20 × 20 nmi; Fig. \@ref(fig:fig-survey-grid)). In 2024, following analysis by @defilippo2023evaluating, the 26 previously sampled 'corner stations' were removed from the survey grid (see [History of Bering Sea Bottom Trawl Surveys](#history) section). `r nbs_str0`
