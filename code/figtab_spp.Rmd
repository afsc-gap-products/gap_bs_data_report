...
if (spp_plot_agecomp) {
  ...
  header <- paste0(header, "(D) Total abundance-at-age estimates were calculated and scaled to the total estimated population from the last ten years of available data (",min(yrs_age),"-", max(yrs_age),") in the ",text_list(srvy_age),"  Bering Sea surveys. ")
