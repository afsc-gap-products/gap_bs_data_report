...
## fig-[st or bt]-temperature-nebs-surveys
...
if (SRVY == "NEBS") {
  ...
  for (i in 1:2) { # two cases, above and below
    ...
    nickname <- paste0("fig-",ifelse(i==1, "bt", "st"),
                       "-temperature-nebs-surveys")
...
nickname0 <- "tab-biomass-est-fish_"
...
nickname0 <- "tab-biomass-est-invert_"
