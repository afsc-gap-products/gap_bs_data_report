...
if (report_title == "data") {
  ...
  nickname <- paste0("fig-", jj, "-", spp_file, "-3-distribution-nbspres")
...
for (case_yr in case_yr0) {
  ...
  if (report_title == "ptpres") {
    ...
    if (report_title %in% c("community", "nbspres")) {
...
if (report_title == "data") {
  ...
  width <- 7
  srvy <- SRVY1 # "NBS"
  nickname <- paste0("fig-", jj, "-", spp_file, "-4-sizecomp-nbspres")
}
...
## fig-nbspres-sizecomp-dist-[spp]

```{r fig-nbspres-sizecomp-dist-[spp], eval = (report_title == "nbspres")}
# width <- full_page_portrait_width # 6.5  
# nickname <- paste0("fig-3-sizecomp-dist-", spp_file, "-nbspres")
# header <- ""
# 
# # Sizecomp plot ----------------------------------------------------------------
# 
...
```{r, fig-[spp]-population-timeseries}
