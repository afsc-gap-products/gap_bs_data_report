...
if (temp$rank[temp$year == maxyr] < 6) {
  temp4 <- paste0(NMFSReports::numbers2words_th(temp$rank[temp$year == maxyr])," lowest")
} 
if (abs(temp$rank[temp$year == maxyr]-length(temp$rank)) < 6) {
  temp4 <- paste0(NMFSReports::numbers2words_th(abs(temp$rank[temp$year == maxyr]-length(temp$rank)))," highest")
}
