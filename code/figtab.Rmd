...
header <- paste0("Stratification scheme used for data analysis of the ", maxyr," ",
                 ...
                 " bottom trawl survey", ifelse(srvy == "NEBS", "s", ""), 
...
header <- paste0("Otolith collection types and target counts during the ", 
                 maxyr, " ", 
                 text_list(haul_cruises_maxyr$srvy_long),
                 " bottom trawl survey", ifelse(length(srvy1)>1, "s", ""),".")
...
header <- paste0("Non-core scientific collections and research projects undertaken during the ",
                 maxyr, " ", 
                 text_list(haul_cruises_maxyr$srvy_long), 
                 " bottom trawl survey, sorted by principal investigator and agency.")
...
header <- paste0("Average summer surface and bottom (points and solid lines), and time series average surface and bottom (dashed lines) temperatures (°C) on the eastern Bering Sea shelf, based on data collected during the eastern Bering Sea bottom trawl survey from 1982–",maxyr,
                 ifelse(srvy == "NEBS", 
                        paste0(" (left), and northern Bering Sea based on data collected during standardized summer bottom trawl surveys (right)"), ""), 
                 ". ")
...
header <- paste0("Annual extent of the summer cold pool on the eastern Bering Sea, based on observations from the eastern Bering Sea bottom trawl survey. The extent of the cold pool is shown as a percentage of the total survey area.",
                 ifelse(srvy == "NEBS", 
...
for (i in 1:nrow(haul_cruises_maxyr)) {
  ...
  header <- paste0("Biological data collected during the ", maxyr, " ", 
                   ...
                   " bottom trawl survey. ") # See \\@SAPcrab", maxyr, " for crab collection summaries. 
...
for (i in 1:nrow(comb)) {
  ...
  header <- paste0("Total taxon biomass estimates (t), ± 95% confidence limits (CL), and biomass estimates by stratum for ", 
                   ...
                   maxyr, " ", 
                   comb$srvy_long[i],
                   " bottom trawl survey. The 'proportion' column represents the total estimated taxon biomass divided by the total estimated ", 
                   ifelse(comb$taxon[i] =="invert", "invertebrate", "fish") ,
                   " biomass (", text_list(formatC(x = total$total, digits = 0, format = "f", big.mark = ",")),
                   " t).")
...
for (i in 1:c(nrow(haul_cruises_maxyr))) {
  ...
  header <- paste0(
    ...
    compareyr," and ",maxyr," ", 
    haul_cruises_maxyr$srvy_long[i], 
    ' bottom trawl surveys for predominant fish and invertebrate taxa. Taxa are listed in descending order of percent change from ',compareyr,' to ',maxyr,'. ') 
...
for (i in 1:length(type)) {
  ...
  header <- paste0(header, "were collected for common groundfish species by survey region during the ",
                   ...
                   " bottom trawl survey",plural_surveys,". ")
...
tab_taxa_found_ <- function(temp, 
  ...
  for (i in 1:nrow(temp)) {
    ...
    header <- paste0(stringr::str_to_sentence(temp$taxon[i]), 
                     ...
                     " shelf bottom trawl survey listed alphabetically by ", 
