...
header <- paste0("Station map of the ",maxyr," ",SURVEY," survey", plural_surveys, ". Dark and light gray outlines denote the eastern and northern shelf areas, respectively. Dots show station locations: filled dots indicate completed stations, and unfilled dots indicate planned stations not sampled in ", maxyr, ".")
...
header <- paste0("Average summer (points and solid lines) surface and bottom, and time series average (dashed lines) surface and bottom temperatures (°C) on the eastern Bering Sea shelf, based on data collected during the eastern Bering Sea shelf survey from 1982–",
...
plot_mean_temperatures <- function(maxyr, srvy){
  ...
  header <- paste0("Average summer surface and bottom (points and solid lines), and time series average (dashed lines) surface and bottom temperatures (°C) on the eastern Bering Sea shelf, based on data collected during the eastern Bering Sea shelf survey from 1982–",maxyr,
                   ifelse(srvy == "NEBS", 
...
height <- 3.5 # full_page_portrait_height
width <- full_page_portrait_width
yrs <- c(maxyr-2):maxyr
row0 <- 1
case_yr0 <- 1
