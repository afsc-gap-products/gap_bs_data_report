...
#   img = here::here("img", paste0(spp_file, ".png")), 
#   text = paste0(lang, "\n\n", paste0(readLines(con = paste0(dir_out_rawdata, spp_file,".txt")), collapse = ""), collapse = ""))
# 
...
#   flextable::padding(part = "body", j = 2, padding = 5) %>%
