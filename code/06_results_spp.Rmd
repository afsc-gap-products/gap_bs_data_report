...
```{r fig-biopop-timeseries-{{jj}}, eval = (report_title %in% c("data"))}
nickname <- paste0("fig-biopop-timeseries-", spp_file)
```

```{r fig-biopop-timeseries-{{jj}}-child, child = paste0(dir_code, "_child_report_figtab.Rmd"), eval = (report_title %in% c("data"))}
```
