...
if (sum(table_raw$catch_min >= 100) == nrow(table_raw)) {
  ...
  header <- paste0(header, 
                   "Too few organisms were observed on the ", text_list(tolower(table_raw$`Bering Sea\nSurvey`[table_raw$catch_min <= 100]))," Bering Sea survey to share meaningful percent change of total biomass values (denoted by '-'), so observed values are shared instead. ")      
    }
