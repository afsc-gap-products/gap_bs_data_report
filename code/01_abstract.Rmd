...
if (nrow(temp0)<(nrow(temps_avg_yr)-6) | 1>temp$warmest_rank<6) {  
  str0 <- paste0(str0, 
...
`r str0`A total of `r fish_sp ` species of fishes were identified during the `r text_list(SRVY1)` survey`r ifelse(SRVY=="NEBS", "s", "")`, representing `r fish_genera` genera and `r fish_family` families, as well as `r invert_spp ` invertebrate taxa. In total, organisms representing `r invert_phyla` phyla were identified in the catch.
