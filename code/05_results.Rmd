...
str0 <- paste0(
  ...
  " taxon were identified to species level (Appendix Table", plural_surveys,
  " A \\@ref(tab:tab-app-taxa-found-EBS-invert)", 
  ifelse(plural_surveys == "s", " and B \\@ref(tab:tab-app-taxa-found-NBS-invert)", ""),
  "). ")
}
```
