...
A total of `r text_list(paste0(haul_cruises_maxyr$stations_completed, " (of ",  haul_cruises_maxyr$stations_avail, ") total stations in the ", haul_cruises_maxyr$SRVY_long))` were successfully sampled in `r maxyr` (Fig. \@ref(fig:fig-survey-sample-stations)). 
...
if (SRVY == "NEBS" & "NBS" %in% haul_cruises_maxyr$SRVY) {
  ...
  for (i in 1:length(SRVY1)){
    temp4 <- text_list(paste0(
      ...
      temp0$str0[temp0$SRVY == SRVY1[i]]), sep_last2 = "; and ")
    temp3 <- paste0(temp3, 
