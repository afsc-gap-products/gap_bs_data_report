...
for (i in 1:length(abcd)) {
  ...
  str0 <- paste0(str0, ifelse(str0 == "", "", "\\pagebreak"), 
                 '## ',abcd[i],': List of taxa encountered in the ', srvy[i], '

',abcd[i],' lists all fish and invertebrate taxa taken during the AFSC’s ',
srvy[i] ,
' bottom trawl survey.
...
',abcd[i],' presents population estimates by sex and size group from the ', maxyr,' ',
