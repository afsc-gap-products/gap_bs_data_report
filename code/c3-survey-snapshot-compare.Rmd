...
str0 <- gsub(pattern = ", and", replacement = "; and", x = str0)
```
...
In `r maxyr`, the total bottom-dwelling animal biomass of the eastern Bering Sea shelf was estimated at `r temp$biomass_mmt[temp$year == maxyr & temp$srvy == "EBS"] ` million metric tons (t) and the northern Bering Sea was estimated at `r temp$biomass_mmt[temp$year == maxyr & temp$srvy == "NBS"] ` million t. Previously, the total bottom-dwelling animal biomass of the `r text_list(paste0(temp$year[temp$year != maxyr], " ", temp$srvy_long[temp$year != maxyr], " was estimated at ", temp$biomass_mmt[temp$year != maxyr], " million t"))`. 
