...
str0 <- paste0(
               "There were noticeable changes in the benthic community of the ",
...
In addition to the discussion for the major fish species below, it is important to hihglight: Unlike the EBS, saffron cod (Eleginus gracilis), was among the 12 most abundant fish species in the NBS, and Arctic cod (Boreogadus saida) was the 18th most abundant. For a descending rank of all organisms caught, see `r ifelse(SRVY == "NEBS", "appendices", "appendix")` `r NMFSReports::crossref(list_obj = list_tables, nickname = "tab_taxa_encountered_*_fish", sublist = "number", exact = FALSE)`.
...
`r NMFSReports::crossreflist_obj = list_tables, nickname = "tab_majortaxa_pchange_", sublist = "res", exact = FALSE) `
