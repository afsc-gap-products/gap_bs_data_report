...
table_print <- flextable::flextable(table_raw) %>%
  ...
  theme_flextable_nmfstm(font = "Arial")
...
for (i in 1:nrow(haul_cruises_maxyr)) {
  ...
  flextable::flextable(data = .) %>%
    ...
    flextable::valign(valign = "top") %>%
    theme_flextable_nmfstm(font = "Arial", x = .)
...
table_print <- table_raw %>% 
  ...
  NMFSReports::theme_flextable_nmfstm(font = "Arial", x = ., row_lines = TRUE) 
...
table_print <- table_raw %>%
  ...
  flextable::padding(x = ., 
                     j = 1, i = ~ is.na(SRVY), 
                     padding.left = 20) %>%
  theme_flextable_nmfstm(font = "Arial", row_lines = TRUE) %>% 
...
table_raw <- catch_haul_cruises_maxyr %>% 
  ...
  table_print <- temp %>%
    ...
    theme_flextable_nmfstm(font = "Arial", row_lines = FALSE) %>%
...
temp1 <- function(table_raw, strat, total) {
  ...
  table_print <- table_print %>%
    ...
    flextable::set_header_labels(.,
                                 ...
                                 "a" = "", 
                                 "prop" = "") %>%
    NMFSReports::theme_flextable_nmfstm(font = "Arial", row_lines = TRUE) 
...
#     NMFSReports::theme_flextable_nmfstm(font = "Arial", row_lines = FALSE)  %>% 
...
table_print <- table_print %>%
  ...
  flextable::set_header_labels(.,
                               ...
                               change = paste0("Change (", maxyr, ", ", compareyr, ")" )) %>% 
  NMFSReports::theme_flextable_nmfstm(font = "Arial", row_lines = FALSE, x = .)  %>% 
