...
The abundance of walleye pollock was relatively high in the NBS middle and outer shelf compared to the inner shelf and in the NBS where bottom depths are generally less than 50 m (Figure 7b). Unlike the EBS, saffron cod (Eleginus gracilis), was among the 12 most abundant fish species in the NBS, and Arctic cod (Boreogadus saida) was the 18th most abundant. For a descending rank of all organisms caught, see `r ifelse(SRVY == "NEBS", "appendices", "appendix")` `r NMFSReports::crossref(list_obj = list_tables, nickname = "tab_taxa_encountered_*_fish", sublist = "number", exact = FALSE)`.
...
for (i in 1:nrow(temp0)) {
  temp <- c(temp, 
                 paste0(
  temp0$print_name[i], " (Figures ", 
  NMFSReports::crossref(list_obj = list_figures, 
                        nickname = paste0("fig_idw_cpue_*_",temp0$file_name[i],"_*"), 
