...
The standardized `r SURVEY` bottom trawl survey`r plural_surveys` use`r ifelse(plural_surveys == "s", "", "s")` has historically consisted of a systematic design with 376 fixed sampling stations arranged on a regularly spaced 37.04 × 37.04 km grid (20 × 20 nautical mile; Fig. \@ref(fig:fig-survey-grid)). Of these 376 stations, 26 were corner stations, added in the early 1980s to better sample regions of historically high blue king crab abundances. However, a recent analysis by DeFilippo et al. (2023) showed that removal of these corner stations in high-density sampling areas would lead to only minor impacts on the precision and accuracy of groundfish biomass estimates. Thus, in the interest of maximizing the efficient use of survey resources, the sampling of the 26 corner stations in high-density sampling zones around St. Matthew and the Pribilof Islands was discontinued in 2024, leaving the sampling density of the entire survey area uniform, with stations spaced 20 nautical miles apart. The 2024 EBS survey area therefore consists of 350 stations, as opposed to the previous total of 376 stations and will continue to include this reduced set of stations in the future.

Corner stations are located at the intersections of the grid lines in the waters surrounding St. Matthew and the Pribilof Islands (Fig. \@ref(fig:fig-survey-grid)). Pribilof island corner stations were added in 1982 and corner stations around St. Matthew's were added in 1983. These corner stations are sampled in addition to the grid cells. `r ifelse(SRVY == "NEBS", paste0("The ",maxyr," northern Bering Sea shelf bottom trawl survey was conducted using the same systematic sampling design for stations bounded by the U.S.-Russian Maritime Boundary and the Bering Strait, including Norton Sound.") , "")` 
