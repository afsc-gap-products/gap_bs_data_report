...
## fig_pres_bottom_surface_temperature_maxyr

```{r fig_pres_bottom_surface_temperature_maxyr}
nickname <- "fig_pres_bottom_surface_temperature_maxyr"
height <- 5
width <- width0
