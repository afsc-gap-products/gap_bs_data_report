...
The mean bottom temperature on the eastern Bering Sea was `3.0`°C in `r maxyr`, which was `0.5`°C warmer than the time series average from 1982 to `r maxyr-1` (both 2.5°C; Fig. \@ref(fig:fig-mean-temperature)). Although temperatures increased from `r maxyr-1` to 2026, the 2026 mean bottom temperature was still classified as near-average (within one standard deviation of the time series mean).Over the history of the eastern Bering Sea survey (1982–`r maxyr-1`), annual mean summer bottom temperatures have ranged from `0.7`°C to `4.4`°C, and surface temperatures have ranged from `3.9`°C to `9.5`°C. The 2026 mean eastern Bering Sea surface temperature (`6.1`°C) was colder than the times-series average surface temperature (`6.7`°C), and warmer than the mean surface temperature in `r maxyr-1` (`5.8`°C). 

## The Cold Pool

The cold pool area is defined as the extent of the eastern Bering Sea survey area with bottom temperatures less than or equal to 2°C [@RohanColdPool] and is strongly correlated (r^2^ = 0.94) with mean bottom temperature on the shelf. The size and location of the cold pool is primarily influenced by the extent of seasonal sea ice cover during the preceding winter and spring and the timing of sea ice retreat during spring [@Stabeno2019a], such that years with extensive sea ice that persists into spring have a larger cold pool that can extend into Bristol Bay and as far south as the Alaska Peninsula.  When the sea ice extent is smaller, the cold pool is limited to the northern edge of the eastern Bering Sea survey area. 
...
The cold pool is primarily found in the middle domain (50–100 m) and covered 23.0% (113,525 km^2^) of the eastern Bering Sea survey area in 2026 and was primarily located north of 57°N (Figs. \@ref(fig:fig-temperature-bt-data) and \@ref(fig:fig-cold-pool-area)). The cold pool was 27.7% (43,425 km^2^) smaller than in 2024 and was 36.6% smaller than the time series mean (179,000 km^2^). The extent of isotherms for bottom temperatures of ≤ 0°C (30,275 km^2^) and ≤ -1°C (8,350 km^2^) were 6.0% and 19.8% larger than in 2024. The extent of the ≤ 0°C and ≤ -1°C isotherms were similar to those observed in warm years. During the 43-year time series, the cold pool area has ranged from a minimum of 6,150 km^2^ in 2018 to a maximum of 385,975 km^2^ in 1999, comprising 1.2% to 78.2% of the total eastern Bering Sea survey area.
