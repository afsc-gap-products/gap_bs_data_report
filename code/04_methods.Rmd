...
nbs_str0 <- ifelse(SRVY == "NEBS", 
                   # NBS sampled
                   paste0(" The standardized northern Bering Sea survey consists of a systematic design with 144 fixed sations."), 
                   # EBS only
                   paste0(" The northern Bering Sea survey was not conducted in ", maxyr, "."))
```

The standardized eastern Bering sea trawl survey consists of a systematic design with 350 fixed sampling stations arranged on a regularly spaced 37.04 × 37.04 km grid (20 × 20 nmi; Fig. \@ref(fig:fig-survey-grid)). In 2024, following analysis by @defilippo2023evaluating, the 26 'corner stations' were removed (see History of Bering Sea Bottom Trawl Surveys section). `nbs_str0`
...
Stomachs were collected from `r xunits(nrow(obj$raw))` fish species and preserved in 10% formalin for later laboratory diet analysis (Table \@ref(tab:tab-stomach-collection-scheme)). Stomach samples were shipped to the Food Habits Lab of the AFSC's REFM Division for diet analysis. Arrowtooth flounder and Kamchatka flounder (*Atheresthes* spp.) stomachs were collected together because they occupy a similar trophic niche in the Bering Sea [@YangandLivingston1986]. 
