...
nickname <- paste0("fig_",spp_file,"_biomass")
...
header <- NMFSReports::text_list(paste0("**", b$Survey, " ", y_long, "** ", 
                                        ...
                                        " ", 
                                        unlist(b[grep(pattern = as.character(max(nbsyr[nbsyr != maxyr])), 
                                                                x = names(b))[1]]), 
                                        " ", a$unt, "")) # , sep_last = "\n\n"
...
nickname <- paste0("fig_",spp_file,"_abundance")
...
if (spp_plot_sizecomp) {
  ...
  width <- 6.5
  header <- ""
  nickname <- paste0("fig_",spp_file,"_lengths")
...
if (spp_plot_idw | spp_plot_pa) {
  ...
  nickname <- paste0("fig_", spp_file, "_", ifelse(spp_plot_pa, "presence", "distribution"))
...
## fig_idw/pa_cpue_[spp]_coldpool

```{r fig_idw_cpue_[spp]_coldpool}

if (spp_plot_idw | spp_plot_pa) {
  
  yrs <- nbsyr[(length(nbsyr)-4):length(nbsyr)]
  
  nickname <- paste0("fig_", spp_file, "_", 
