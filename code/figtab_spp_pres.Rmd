...
figure0 <- plot_timeseries(dat = bio,
                          unit = "metric tons",
                          unt = "mt",
                          y_long = "biomass",
...
figure <- cowplot::plot_grid(figure0, descr, nrow = 1, rel_widths = c(1, .4))


# figure <- cowplot::ggdraw(add_sub(figure0, "This is an annotation.\nAnnotations can span multiple lines."))
...
if (spp_plot_idw | spp_plot_pa) {
  ...
  nickname <- paste0("fig_pres_", spp_file, "_", ifelse(spp_plot_pa, "presence", "distribution"))
...
## fig_pres_idw/pa_cpue_[spp]_coldpool

```{r fig_pres_idw_cpue_[spp]_coldpool}
