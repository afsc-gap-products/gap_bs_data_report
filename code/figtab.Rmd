...
for (i in 1:nrow(haul_cruises_maxyr)) {
  ...
  header <- paste0("Biomass estimates (t) for major invertebrate taxa collected during the ", 
                   maxyr, " ", 
                   haul_cruises_maxyr$SRVY_long[i],
                   " shelf bottom trawl survey. Crab data is summarized under other crustaceans and discussed in detail in the annual crab technical memorandum produced by the shellfish assessment program. ")
