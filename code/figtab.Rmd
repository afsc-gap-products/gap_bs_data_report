...
for (i in 1:nrow(comb)) {
  ...
  header <- paste0("Total taxon biomass estimates (t), ± 95% confidence limits (CL), and biomass estimates by stratum for major ", 
                   ...
                   maxyr, " ", 
                   comb$SRVY_long[i],
                   " bottom trawl survey. The proportion of the taxon biomass is divided by the total ", 
                   ifelse(comb$taxon[i] =="invert", "invertebrate", "fish") ,
...
for (i in 1:c(nrow(haul_cruises_maxyr))) {
  ...
  header <- paste0(
    ...
    compareyr," and ",maxyr," ", 
    haul_cruises_maxyr$SRVY_long[i], 
    ' bottom trawl surveys for predominant fish and invertebrate taxa. Taxa are listed in descending order of percent change from ',compareyr,' to ',maxyr,'. Differences in percent changes are due to rounding in estimated biomass. ') 
