...
The standardized eastern Bering Sea survey consists of a systematic design with 350 fixed sampling stations arranged on a regularly spaced 37.04 km^2 grid (20 nmi^2; Fig. \@ref(fig:fig-survey-grid)). In 2024, following analysis by @defilippo2023evaluating, the 26 previously sampled 'corner stations' were removed from the survey grid (see [History of Bering Sea Bottom Trawl Surveys](#history) section). `r nbs_str0`
...
if (sum(temp$N, na.rm = TRUE)>0) {
  ...
  for (i in 1:length(unique(temp$srvy))){
    ...
    str0 <- paste0(str0, 
                   ...
                   "he net mensuration system failed to record [?net and spread?] data for ", 
