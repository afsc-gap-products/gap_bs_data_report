...
dist_plot <- function(yrs, height, row0, nickname, report_title0) {
...
temp <- dist_plot(yrs, height, row0, nickname, report_title0)
...
figure_print <- cowplot::plot_grid(temp1, temp2, nrow = 2, rel_heights = c(1,.8))
