...
## fig-idw-cpue-[taxon]-[spp]-[above and below]

```{r fig-idw-cpue-[taxon]-[spp]-[above and below]}
# if (report_title == "data") {
if (spp_plot_idw_coldwarm){
  
  nickname0 <- paste0("fig-idw-cpue-",spp_taxon,"-", spp_file, "-")
  ...
  for (i in 1:2) { # two cases, above and below
    ...
    header <- paste0(
      "The distribution (weight CPUE (kg/ha)) of ", 
                     spp_print, 
                     ifelse(is.na(spp_sci), "", 
                            paste0(" (",spp_sci,")")), 
                     " in years when the survey mean bottom temperature was ",
                     case,
                     " the long-term mean ",
...
## fig-idw/pa-cpue-[taxon]-[spp]

```{r fig-idw-cpue-[taxon]-[spp]}
