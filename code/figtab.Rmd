...
for (case in c("bottom", "surface")) {
    nickname <- paste0("fig-temperature-", ifelse(case=="bottom", "bt", "st"), 
                       "-data")
    a <- temp(yrs = yrs, 
              row0 = row0, 
              title0 = "", 
...
for (i in 1:c(nrow(haul_cruises_maxyr))) {
  ...
  header <- paste0(
    ...
    haul_cruises_maxyr$srvy_long[i], 
    ' shelf surveys for predominant fish and invertebrate taxa. Taxa are listed in descending order of percent change from ',compareyr,' to ',maxyr,'. ', 
    ifelse("-" %in% table_print0$change, paste0("Percent changes denoted with '-' indicate that fewer than 100 individuals were caught on the survey",plural_surveys," in ", compareyr," or ",maxyr, ". "), "")) 
