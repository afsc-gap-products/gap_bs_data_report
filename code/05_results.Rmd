...
for (i in 1:length(srvy1)) {
  ...
  temp1 <- taxon_count |> 
    dplyr::filter(srvy == sort(srvy1)[i])
  
  str0 <- paste0(str0, ifelse(i == 1, "In", "\n\nSimilarly, in"))
  ...
  str0 <- paste0(
    ...
    ifelse(sort(srvy1)[i] == "EBS", "A", "B"),
    " \\@ref(tab:tab-app-taxa-found-", sort(srvy1)[i], "-fish)", 
    "). Of these ",
    fish_sp_code," taxa, ",
    ...
    invert_phyla,
    " phyla were identified on the ",maxyr," survey",plural_surveys,"; ",
    invert_sp,
