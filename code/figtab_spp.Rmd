...
if (ncol(table_print0) > 2) {
  ...
  # replace entries for biomass % rows with "-"
    table_print0[table_print0$var == "% of Total Biomass", c(2:ncol(table_print0))][which(table_print0[table_print0$var == "catch_min", c(2:ncol(table_print0))]<=100)] <- "-"
        table_print0[table_print0$var == "% Change in Biomass", c(2:ncol(table_print0))][which(table_print0[table_print0$var == "catch_min", c(2:ncol(table_print0))]<=100)] <- "-"
...
if (sum(table_raw$catch_min >= 100) == nrow(table_raw)) {
  ...
  header <- paste0(header, 
                   "Too few organisms were observed on the survey to share meaningful percent change of total biomass values, so observed values are shared instead. ")      
    }
