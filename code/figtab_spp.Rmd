...
key.title <- paste0(stringr::str_to_title(spp_print), # paste0(toupper(substr(x = spp_print, start = 1, stop = 1)), substr(x = spp_print, start = 2, stop = nchar(spp_print))), # 
...
figure <-
  ...
  ggplot2::geom_point(size = 2, mapping = aes(shape = SRVY_long)) + 
  # axis aesthetics 
