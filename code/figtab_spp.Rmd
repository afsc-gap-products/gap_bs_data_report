...
height <- full_page_portrait_height-3
width <- full_page_portrait_width

pres_timeseries <- pres_timeseries + 
                              ggplot2::ggtitle("") + 
                              ggplot2::guides(fill = "none") +
                              ggplot2::labs(color = "") + 
                              ggplot2::labs(shape = "") +
...
if (exists("pres_size")) {
  figure_print <- cowplot::plot_grid(pres_dist, 
                              cowplot::plot_grid(pres_size, pres_spp, ncol = 2, rel_widths = c(1.5, .5)), 
                              pres_timeseries,
                              nrow = 3, 
                              rel_heights = c(1,1,.7))
} else {
