...
header <- header0 <- paste0(
  ...
  "Top left: ", 
  "Total abundance-at-length estimates by sex encountered during the ", maxyr, " eastern and northern Bering Sea shelf surveys. Length distributions are scaled to the total estimated population size.
", # pres_size_txt, 
...
header <- paste0(header0, " Bottom left: Icon of ", spp_print, ". ")
