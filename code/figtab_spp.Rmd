...
if (spp_plot_idw_coldwarm){
  ...
  if (length(years)<3) {
    ...
    figure <- plot_idw_xbyx(
      ...
      row0 = row0) + 
      ggtitle(paste0("CPUE in Years of ", stringr::str_to_sentence(case), " Mean Temperature"))
...
if (spp_plot_idw | spp_plot_pa) {
  ...
  height <- 4 #full_page_portrait_height - ifelse(SRVY == "NEBS", 5, 4) # height <- 6
  width <- full_page_portrait_width # 6.5
...
if (spp_plot_sizecomp) {
  ...
  height <- full_page_portrait_height #2 7
      ...
      if (i == 1) { # CPUE (WT/HA) and BIOMASS
        ...
        if (nrow(table_raw) != 0) { # if none were caught, don't do any of this
          ...
          header <- paste0("Mean CPUE by weight",meanwgtcpue0$unit_word,
                           ...
                           " and 95% lower (LCL; ",biomass0$unit_word,
                           ") and upper (UCL; ",biomass0$unit_word,
        ...
        if (nrow(table_raw) != 0) { # if none were caught, don't do any of this
          ...
          header <- paste0("Mean CPUE by number", meannumcpue0$unit_word,
                           ...
                           " and 95% lower (LCL; ",population0$unit_word,
                           ") and upper (UCL; ",population0$unit_word,
                           ") confidence limits for ")
