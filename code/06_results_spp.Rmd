...
`r NMFSReports::crossref(list_obj = list_figures, nickname = paste0("fig_sizecomp_*", spp_file), sublist = "res", exact = FALSE)`

`r NMFSReports::crossref(list_obj = list_figures, nickname = paste0("fig_idw_cpue_*", spp_file, "*"), sublist = "res", exact = FALSE)`
