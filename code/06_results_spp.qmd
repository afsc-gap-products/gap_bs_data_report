...
fig_bt <- "(#fig-temperature-bt-1) and (#fig-temperature-bt-2)"
...
```{r tab-stats-{{jj}}-child, child = paste0(dir_code, "_child_report_figtab.qmd"), eval = (report_title %in% c("community", "data"))}
```
...
```{r tab-bio-timeseries-{{jj}}-child, child = paste0(dir_code, "_child_report_figtab.qmd"), eval = (report_title %in% c("community", "data"))}
```
