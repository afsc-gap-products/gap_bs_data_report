...
tab_taxa_encountered_ <- function(temp, 
  ...
  for (i in 1:nrow(temp)) {
    ...
    table_print <- table_print %>%
      ...
      flextable::width(x = ., width = .6, unit = "in") %>%
      flextable::width(x = ., width = 1, j = "stations_n", unit = "in") %>%
      flextable::width(x = ., width = 1.5, j = c("taxon"), unit = "in") %>%
      flextable::width(x = ., width = 1.75, j = c("species_name", "common_name"), unit = "in") %>%
      flextable::align(x = ., 
