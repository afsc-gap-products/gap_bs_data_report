...
`r NMFSReports::text_list(x = paste0(maxyr, " ", haul_cruises_maxyr$SRVY, " survey results with those from the ", haul_cruises_maxyr$compareyr, " ", haul_cruises_maxyr$SRVY, " survey"))` [@RN976], which `r ifelse(SRVY == "NEBS", "are", "is")` the most recent and, similar, and comparable past survey`r ifelse(SRVY == "NEBS", "s", "")`. `r ifelse(SRVY == "NEBS", paste0("To simplify the report from here forward, the terms “EBS” and “NBS” will be used to refer to the eastern and northern Bering Sea bottom trawl survey areas, respectively."), "")` For results referenced from previous surveys, refer to the AFSC Technical Memoranda here at the end of the report and listed on the AFSC website (https://www.fisheries.noaa.gov/resource/publication-database/alaska-fisheries-science-center-technical-memorandums).
