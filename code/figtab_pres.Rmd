...
figure2 <- plot_temps_facet(
  rasterbrick = rasterbrick, 
  key.title = expression(bold("Temperature (°C)")), # expression(bold("Surface Temperature (°C)"))
  reg_dat = report_types$NEBS$reg_dat, 
  colorbar_breaks = c(-Inf, seq(from = 0, to = 14, by = 2), Inf),
  viridis_palette_option = "H", 
  row = 1, 
...
figure <- cowplot::plot_grid(figure2$figure + 
