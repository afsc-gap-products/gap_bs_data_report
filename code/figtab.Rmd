    ...
    flextable::compose(j = "dummy", part = "body",
                       value = as_paragraph(
                         as_chunk(paste0(name, "\n"),
                                  props = fp_text_default(bold = TRUE, font.size = 12, font.family = font0)), 
                         as_chunk(paste0(title, "\n"),
                                  props = fp_text_default(italic = TRUE, bold = TRUE, font.size = 10, font.family = font0)), 
                         as_chunk(bio,
                                  props = fp_text_default(font.size = 10, font.family = font0)))) %>%  
