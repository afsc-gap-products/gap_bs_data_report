...
header <- paste0("Map of ",maxyr," ",SURVEY," survey",plural_surveys," sampling stations. The area enclosed within the dark gray line contains the eastern Bering Sea shelf stations that have been sampled annually since 1982, whereas the area outlined by the light gray line contains the northern Bering Sea stations that were sampled in ",maxyr,". The dots within each area indicate station locations. Solid dots are those stations that were completed, while the open (outlined) dots are those that were not completed in ",maxyr,".") 
