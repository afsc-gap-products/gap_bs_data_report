...
header <- paste0("Station map of ",maxyr," ",SURVEY," survey", plural_surveys, ". The areas enclosed within the dark and light gray lines contain the eastern and northern Bering Sea shelf stations, respectively. The dots within each area indicate station locations. Filled dots are completed stations; unfilled dots represent planned stations that were not sampled in ", maxyr, ".")
...
for (i in 1:c(nrow(haul_cruises_maxyr))) {
  ...
  header <- paste0(
    ...
    haul_cruises_maxyr$srvy_long[i], 
    ' shelf surveys for predominant fish and invertebrate taxa', 
