...
# str <- c()
# 
# for (i in 1:stratum_info$SRVY){
# 
# str <- NMFSReports::text_list( paste0(
#   ifelse(sum(!(stratum_info$stations_completed == stratum_info$stations_avail))>0, 
#          paste0("All ", stratum_info$stations_avail, " stations were"), 
#          paste0("Of the ", stratum_info$stations_avail, " stations available, ", stratum_info$stations_completed, " were completed")), 
#   " in the ", stratum_info$SRVY
# ))
# 
# }
```
