...
for (i in 1:nrow(temp)) {
  ...
  for (ii in 1:ceiling(ncol(table_print)/ncol_per_page)) {
    ...
    names(table_print0)[names(table_print0) == "temp"] <- rep_len(x = " ", length.out = ii)
    
    # print(paste0(ii, ": ", c_start, "-", c_end))
    c_start <- c_end
  }
...
#                                  row = "") %>%
#   theme_flextable_nmfstm(font = "Arial Narrow", row_lines = FALSE, body_size = 8)
