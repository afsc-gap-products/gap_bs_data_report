...
temp <- obj$raw
cite_bio <- paste0(" (Tables \\@ref(tab:tab-est-spp-wt), ", tab_stat,", and ", tab_wt,"; Fig. ", fig_biopop,")")
cite_pop <- paste0(" (Tables \\@ref(tab:tab-est-spp-num), ", tab_stat,", and ", tab_no,"; Fig. ", fig_biopop,")")
...
if (nrow(temp) == 1 & length(SRVY11)==2) { # temp$SRVY_long %in% stringr::str_to_title(SRVY11)
  str0 <- paste0(str0, 
                 ...
                 " in ",maxyr,"  (Fig. ", fig_dist,"; Tables \\@ref(tab:tab-est-spp-wt), \\@ref(tab:tab-est-spp-num),", tab_stat,", ", tab_wt,", and ", tab_no, "). ")
}
```
