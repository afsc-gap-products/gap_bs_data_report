...
figure_bio <- a <- temp00(table_raw, yrs, maxyr, compareyr, unit, unt, y_long, legend_combined = FALSE, mean_in_legend = FALSE)
header <- a$header
figure <- a$figure
...
figure_abund <- a <- temp00(table_raw, yrs, maxyr, compareyr, unit, unt, y_long, legend_combined = FALSE, mean_in_legend = FALSE)
header <- a$header
figure <- a$figure
# temp00(table_raw, yrs, maxyr, compareyr, unit, unt, y_long, legend_combined = FALSE)
