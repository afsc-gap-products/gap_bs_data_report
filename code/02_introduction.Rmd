...
```{r}
# a <- list_figures$fig_sampled_survey_stations
# 
# ```{r fig_sampled_survey_stations, fig.cap = a$caption, fig.id = a$nickname,  tab.cap.style = "Figure Caption", fig.id = "fig_sampled_survey_stations"}
# include_graphics(path = paste0(dir_out_figures, a$filename, ".png"))
# ```
# 
# Fig. \@ref(fig:fig_sampled_survey_stations)
# 
```
