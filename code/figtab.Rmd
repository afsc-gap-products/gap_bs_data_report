...
# m maturity - add this! #TOLEDO
# SELECT 
#     s.SPECIES_CODE,
#     COUNT(s.MATURITY) AS MATURITY_COUNT
# FROM GAP_PRODUCTS.SPECIMEN s
# JOIN GAP_PRODUCTS.HAUL h 
#     ON s.HAULJOIN = h.HAULJOIN
# JOIN GAP_PRODUCTS.CRUISE c
#     ON h.CRUISEJOIN = c.CRUISEJOIN
# WHERE h.DATE_TIME_START >= DATE '2026-01-01'
#   AND h.DATE_TIME_START < DATE '2027-01-01'
#   AND s.MATURITY IS NOT NULL
...
flextable_color_range <- function(ft, dat0, var0, rnge = -9:9) {
 ...
 for (ii in 1:unique(table_raw$srvy)) {
