...
str0 <- paste0(str0, 
  ...
  haul_cruises_maxyr1$stations_available,
  ...
  "Bottom depths in the this survey area range from ",
...
The northern Bering Sea survey region is bounded by the Bering Strait, Norton Sound, and the U.S.–Russia Maritime Boundary (Fig. \@ref(fig:fig-survey-points-nostrata)). The northern Bering Sea region has used the same standardized sampling methods as it was designed as an extension of the systematic 20 × 20 nautical mile (nmi) sampling grid for the annual eastern Bering Sea shelf survey in 2010. 

`r str0 ` 

Both vessels used an 83-112 Eastern otter trawl that has been historically used for eastern Bering Sea, Chukchi Sea, and Beaufort Sea surveys (Fig. \@ref(fig:fig-trawl-gear-diagram-nolabel)). Each trawl tow was conducted for 30 minutes at a speed of 2.8 - 3.2 knots.
