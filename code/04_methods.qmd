...
```{r tab-oto-collection-scheme-child, child = paste0(dir_code, "_child_report_figtab.qmd")}
```
...
```{r tab-stomach-collection-scheme-child, child = paste0(dir_code, "_child_report_figtab.qmd")}
```
