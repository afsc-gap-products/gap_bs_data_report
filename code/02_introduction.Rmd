...
if (sum(haul_cruises_maxyr$SRVY %in% "NBS")>0) {
  temp2 <- cruises %>% 
    ...
    unlist()
  insert2 <- paste0(insert2,
                         'The standardized NBS survey has only been conducted previously in ',text_list(temp2),' [@RN909]. ')
}
