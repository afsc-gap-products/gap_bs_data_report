...
spp_plot_sizecomp <- nrow(sizecomp_maxyr[sizecomp_maxyr$species_code %in% spp_code &
                                           sizecomp_maxyr$SRVY %in% SRVY1,]) > 0 # ifelse(is.na(a$plot_sizecomp[1]), FALSE, a$plot_sizecomp[1])
