...
```{r intro_insert_text}
str0 <- readtext2(file = paste0(dir_out_rawdata, "/0_history.docx"), 
                    refcontent = refcontent)
```

`r str0`

Fig. \@ref(fig:fig-sampled-survey-stations))
Fig. \@ref(fig:fig-sample-grid))
...
```{r, echo = FALSE, fig.cap = caption, fig.id = "fig_sample_grid",  tab.cap.style = "Figure Caption"}
knitr::include_graphics(paste0(dir_out_figures, nickname, ".png"))
```

![alt text here](C:/Users/emily.markowitz/Documents/Projects/gap_bs_data_report//output//2022-11-15//2022_data//figures/fig_sample_grid.png)
