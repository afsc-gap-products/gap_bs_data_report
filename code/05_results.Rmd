...
```{r tab-biomass-est-wt}
nickname <- "tab-biomass-est-wt"
sep0 <- "\\pagebreak"
```

```{r tab-biomass-est-wt-child, child = paste0(dir_code, "_child_report_figtab.Rmd")}
```


```{r tab-biomass-est-num}
nickname <- "tab-biomass-est-num"
sep0 <- "\\pagebreak"
```

```{r tab-biomass-est-num-child, child = paste0(dir_code, "_child_report_figtab.Rmd")}
```
