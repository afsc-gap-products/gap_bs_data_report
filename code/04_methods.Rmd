...
if ("NBS" %in% haul_cruises_maxyr$SRVY) {
  ...
  str00 <- paste0(
    "After the completion of the eastern Bering Sea shelf survey, both vessels began sampling survey stations in the southwest corner of the northern Bering Sea survey region. In the northern Bering Sea, ", 
...
temp <- obj$raw %>% 
  ...
  SRVY_long = dplyr::case_when(
    SRVY_long == "Eastern and northern Bering Sea Combined" ~ "eastern and northern Bering Sea", 
    SRVY_long == "Northern Bering Sea" ~ "just the northern Bering Sea",
    SRVY_long == "Eastern Bering Sea" ~ "just the eastern Bering Sea" )) %>% 
  dplyr::arrange(-n)
