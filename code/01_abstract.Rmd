...
for (i in 1:length(SRVY1)){
  ...
  str0 <- paste0(
    ...
    ifelse(temp_compare < temp_max, "increased", "decreased"),
    " from ", 
    xunits(temp_compare) ,
    ifelse(i == 1, " metric tons (t) ", " t "), 
    "in ", compareyr, " to ", 
    xunits(temp_max), " t", 
    " in ", maxyr, ", which is similar to the time series average of ", 
    xunits(temp_mean$total_mean))
...
str0_biomass <- paste0(
  str00, 
  "Combined, a total of ", fish_sp ," species of fishes and ", invert_spp, 
