...
```{r abstract, child = paste0(dir_code, "01_abstract.Rmd"), results='asis', eval = FALSE}
```

```{r introduction, child = paste0(dir_code, "02_introduction.Rmd"), results='asis', eval = FALSE}
```

```{r methods, child = paste0(dir_code, "04_methods.Rmd"), results='asis', eval = FALSE}
```
...
```{r endmatter, child = paste0(dir_code, "10_endmatter.Rmd"), results='asis', eval = FALSE}
```
