...
str0_coverage <- ifelse(SRVY == "NEBS", 
                   ...
                   # EBS
                   paste0("The survey covers the Bering Sea continental shelf (bottom depths between 20 and 200 meters (m)) from the Alaska coastline to the U.S.-Russia Maritime Boundary between the Alaska Peninsula and roughly 62° N latitude. "))
