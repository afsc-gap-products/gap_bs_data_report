...
table_print <- table_print0 |> 
  ...
  flextable::bg(
    ...
    j = names(table_print0)[2]) |> 
  flextable::bg(
    i = ~ (grepl(x = table_print0[,names(table_print0)[2]], pattern = "o change")), 
    bg = neutral, 
    j = names(table_print0)[2]) 
...
figure_print <- cowplot::ggdraw(figure_print) +
  cowplot::draw_label("A", 
                      x = ifelse(exists("comm_size"), 0.10, 0.01), y = 0.94, hjust = 0, vjust = 0, size = 16) +
  cowplot::draw_label(ifelse((exists("comm_size")), "C", "B"), 
                      x = ifelse(exists("comm_size"), 0.10, 0.01), y = 0.32, hjust = 0, vjust = 0, size = 16) #+
  # cowplot::draw_label(ifelse((exists("comm_size")), "D", "C"), x = 0.77, y = 0.32, hjust = 0, vjust = 0, size = 16)
