...
[pull request](https://github.com/EmilyMarkowitz-NOAA/gap_bs_data_report/pulls), 
[submit an issue to the GitHub organization](`r "https://github.com/afsc-gap-products/data-requests/issues"`), or 
[submit an issue to the code's repository](%60r%20paste0(link_repo,%20%22/issues%22)%60).
