...
A total of `r text_list(paste0(haul_cruises_maxyr$stations_completed, " ", haul_cruises_maxyr$SRVY_long, " stations"))` were successfully sampled in `r maxyr` (Fig. \@ref(fig:fig-survey-sample-stations)). 
