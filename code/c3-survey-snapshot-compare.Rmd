...
`r str0`The biomass of predominant species are listed in Table \@ref(tab:tab-majortaxa-pchange-NBS) in order of largest increase to largest decrease. 
...
Survey results for select taxa are presented with a photograph of the taxon, a summary of results, maps of geographic distribution of CPUE (kg/km^2^), and plots showing total population estimates by size. Maps of species distributions include both the eastern and northern Bering Sea survey regions to better illustrate patterns and trends in fish distribution and movement. For comparison, distribution maps and abundance-at-size plots show survey data for the `r text_list(nbsyr) ` surveys. Detailed summary profiles describing ecologically significant trends for several of the species are included below. 
