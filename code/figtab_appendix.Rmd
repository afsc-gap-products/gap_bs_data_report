...
table_print <- flextable::flextable(table_print) %>%
  ...
  flextable::set_header_labels(.,
                                 row = "") %>%
  theme_flextable_nmfstm(font = "Arial Narrow", row_lines = FALSE, body_size = 9)
...
table_print <- table_print %>%
  ...
  theme_flextable_nmfstm(font = "Arial Narrow", row_lines = FALSE, body_size = 9, header_size = 9)
