...
header <- paste0("Composition of fish taxa encountered in the ",
                 text_list(paste0(haul_cruises_maxyr$SRVY_long, " shelf"))," survey catches. ")
...
if (!("NBS" %in% catch_haul_cruises_maxyr$SRVY)) {
  ...
  table_print <- flextable::flextable(
    ...
    flextable::compose(i = 1, j = "dummy_ebs", part = "header",
                       as_paragraph("Encountered in eastern but not in northern Bering Sea\nCommon Name ", 
    ...
    flextable::compose(i = 1, j = "dummy_nbs", part = "header",
                       as_paragraph("Encountered in northern but not in eastern Bering Sea\nCommon Name ", 
                                    as_chunk(paste0("(Scientific Name)"),
                                             props = fp_text_default(italic = TRUE, bold = TRUE, 
                                                                     font.size = 10, font.family = font0)))) %>%  
    theme_flextable_nmfstm(row_lines = FALSE, 
