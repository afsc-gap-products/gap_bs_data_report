...
This technical memorandum compares results from the `r text_list(paste0("the ", maxyr, " ", SRVY11, " survey and the results from the ", compareyr, " ", SRVY11, " shelf bottom trawl survey"))`.  Past survey data memoranda can be found on the NOAA Central Library ([https://repository.library.noaa.gov/](https://repository.library.noaa.gov/)) and AFSC websites ( [https://www.fisheries.noaa.gov/resource/publication-database/alaska-fisheries-science-center-technical-memorandums](https://www.fisheries.noaa.gov/resource/publication-database/alaska-fisheries-science-center-technical-memorandums) and [https://www.fisheries.noaa.gov/alaska/science-data/groundfish-assessment-program-bottom-trawl-surveys](https://www.fisheries.noaa.gov/alaska/science-data/groundfish-assessment- program-bottom-trawl-surveys)).
