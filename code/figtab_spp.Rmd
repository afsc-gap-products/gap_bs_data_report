...
if (srvy == "EBS") {
  ...
  # combine
  pres_size <- cowplot::plot_grid(pres_size_ebs + 
...
```{r tab-stats-[spp], eval = c(report_title %in% c("community", "data")), eval = FALSE}
...
```{r tab-est-[spp]-[wt or num], eval = FALSE}
...
if (FALSE) { # TOLEDO
  figure_print <- ggdraw(add_sub(
    plot = figure_print, 
    label = paste0(pres_stats$srvy, " ", spp_print, " Biomass Mean: ", 
