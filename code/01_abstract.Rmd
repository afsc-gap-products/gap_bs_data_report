...
str0_stations <- paste0(
  "Survey sampling was conducted by chartering ", (numbers2words(nrow(vessels0))),
  " commercial stern trawlers", plural_surveys,", the ", 
...
In `r maxyr`, the Groundfish and Shellfish Assessment Programs in the Resource Assessment and Conservation Engineering Division of the National Marine Fisheries Service’s Alaska Fisheries Science Center conducted the `r str0_srvys`. `r paste0(str0_coverage, str0_stations, str0_temperature, str0_biomass)`This report compares the distribution and relative abundance of `r xunits(sum(!is.na(report_spp$order[report_spp$taxon == "fish"])))` fish species and `r xunits(sum(!is.na(report_spp$order[report_spp$taxon == "invert"])))` invertebrate taxa with side-by-side maps from the `r maxyr` `r SURVEY` shelf bottom trawl survey and past surveys. `r str0_conclusion`
