...
```{r ebs}
if (nrow(biomass_cpue[(biomass_cpue$SRVY == "EBS" & biomass_cpue$print_name == spp_print),])>0) {
temp <- ""
temp1 <- ""
if (refcontent) {
...
if (refcontent) {
if (SRVY %in% "NEBS") {
if (nrow(biomass_cpue[(biomass_cpue$SRVY == "NBS" & biomass_cpue$print_name == spp_print),])>0) {
temp<-species_content(
