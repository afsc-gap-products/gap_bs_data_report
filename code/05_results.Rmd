...
str0 <- paste0(
  ...
  " than the time series mean (", round(x = temp$st_mean, digits = 1),"°C) (Figures ", 
...
Shelf-wide distributions of the four major commercial crab species: blue king crab (*Paralithodes platypus*), red king crab (*Paralithodes camtschaticus*), snow crab (*Chionoecetes opilio*), and Tanner crab (*Chionoecetes bairdi*) are shown in Figures `r NMFSReports::crossref(list_obj = list_figures, nickname = "fig_idw_cpue_*_crab", sublist = "number", exact = FALSE)`. Commercial crab stocks are managed by the ADF&G with federal oversight by NOAA Fisheries. Detailed information on bottom trawl survey results for commercial crab are reported elsewhere [@RNChilton2011; @RN973]. The most recent modeling results on the status of these commercial crab stocks are reported in the annual Stock Assessment and Fishery Evaluation report prepared by the NPFMC [`r paste0("@NPFMC", maxyr)`].
