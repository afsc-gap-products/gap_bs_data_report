...
`r ifelse(refcontent, "*REFERENCE MATERIAL FOR WRITERS - START*", "")`
...
temp<-species_content(
  ...
  maxyr = maxyr, 
  compareyr = compareyr, 
  biomass_cpue_tab_name = c("tab_majortaxa_pchange_EBS", "tab_majortaxa_pchange_NBS", "table_est_wt", "table_est_num"))
temp1<-temp$table_spp
temp <- temp$text_spp
}
```
...
`r ifelse(refcontent, "*REFERENCE MATERIAL FOR WRITERS - END*", "")`
