...
if ("EBS" %in% temp$srvy) {
  ...
  str0 <- paste0(str0, 
                 case, 
                 " on the ", maxyr, " eastern Bering Sea shelf survey from ", compareyr[names(compareyr) == "EBS"], ifelse(report_title == "data", cite_bio,  ""), 
                 ifelse(spp_print == "tunicates", ". ", paste0(" and the population was estimated at ", temp0$Population," individuals",cite_pop,". ")))
}
...
if ("NBS" %in% temp$srvy) {
  ...
  str0 <- paste0(str0, str0_transition, 
                 ...
                 " on the ", maxyr, " northern Bering Sea survey from ", 
                 compareyr[names(compareyr) == "NBS"], ifelse(report_title == "data", cite_bio,  ""), 
                 ifelse(spp_print == "tunicates", ". ", paste0(" and the population was estimated at ", temp0$Population," individuals")), cite_pop,". ")
}
