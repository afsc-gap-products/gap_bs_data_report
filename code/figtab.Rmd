...
#                   SRVY %in% SRVY1 & 
#                   taxon == "fish") %>% 
#   dplyr::select(species_code, species_name, stratum, biomass, varbio) %>% 
#   dplyr::mutate(taxon_group = round(rnorm(n = nrow(.), mean = 2, sd = 1), digits = 0), 
#                 taxon = paste0(species_name, "(", species_name, ")"), 
#                 prop = NA) %>% 
#   dplyr::rename(c95 = varbio)
# 
# # by stratum
# temp1 <- temp %>% 
#   dplyr::select(stratum, taxon_group, taxon, biomass) 
