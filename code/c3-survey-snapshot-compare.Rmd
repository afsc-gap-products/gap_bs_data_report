...
str0 <- paste0(str0, 
  ...
  "In ", maxyr,", ", srvy11[i], 
  " survey, the total area sampled by trawls at the ", 
  ...
  "% of the total area of the ",srvy11[i],". In ", compareyr[names(compareyr) == srvy1[i]],", the total area sampled by trawls at the ", haul_cruises_compareyr1$stations_completed ,
  " completed stations was approximately ", round(temp1, 2)," nmi^2^ (", round(temp1/divnmi2forkm2, 2)," km^2^), covering ", formatC(x = ((temp1 / sum(stratum1$area_nmi2, na.rm=TRUE)) * 100), format = "f", digits = 4),"% of the total area of the northern Bering Sea. \n\n")
