...
# **List of Tables**
# 
# `r text_list(paste0("\n\n - A ", sapply(list_tables[grepl(x = names(list_tables), pattern = "tab_app_hauls_catch_")],"[[","header")), sep = " ", sep_last = " ") `
# 
...
text_list(paste0("\n\n - Appendix **", abcd, "** \\@ref(tab:", captions$id, "): ", captions$capt),
          ...
          oxford = FALSE, sep = " ", sep_last = " ", sep_last2 = " "),
'
...
```{r tab-app-taxa-found-NBS, eval = evalTF}
...
```{r tab-app-fish-EBS-child, child = paste0(dir_code, "_child_report_figtab.Rmd")}
```

<!-- `r ifelse(evalTF, "\\beginsupplementappD", "")` -->

```{r tab-app-fish-NBS-, eval = evalTF}
...
```{r tab-app-fish-NBS-child, child = paste0(dir_code, "_child_report_figtab.Rmd"), eval=evalTF}
```
