...
if (sum(haul_cruises_maxyr$SRVY %in% "EBS")>0) {
  insert2 <- paste0(insert2, 
                    ...
                    'since 1982 and is the longest-running, standardized timeseries of fish and invertebrate data in the region [@RN976]. ')
}
...
The purpose of the bottom trawl `r ifelse(SRVY=="NEBS", "surveys", "survey")`survey is to collect information about the fish and invertebrate populations and environmental conditions. In `r maxyr`, the Resource Assessment and Conservation Engineering (RACE) Division of National Marine Fisheries Service's (NMFS') Alaska Fisheries Science Center AFSC conducted `r text_list(paste0('the ', haul_cruises_maxyr$yrofsurvey, haul_cruises_maxyr$stndth, " " , haul_cruises_maxyr$SRVY," shelf standardized bottom trawl survey"))`. `r insert2` `r insert`
...
In this document, we will compare the `r maxyr` `r NMFSReports::text_list(SRVY1)` survey results with those from the `r compareyr` `r NMFSReports::text_list(SRVY1)` survey [`r ref_compareyr`], which is the most recent and similar past, comparable survey.
