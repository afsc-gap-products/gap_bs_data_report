...
temp <- data_timeseries_mean |> 
  ...
  tidyr::pivot_wider(id_cols = srvy_long, names_from = y_long, values_from = c("y_mean", "unit"))
...
header <- paste0(
  ...
  paste0(temp$srvy_long, ": ", 
       round(temp$y_mean_Biomass, digits = 1), " ", 
       temp$unit_Biomass, 
       " biomass, ", 
       round(temp$y_mean_Population, digits = 1), " ", 
       substr(x = temp$unit_Population, start = 1, stop = nchar(temp$unit_Population)-1), " individuals", 
       collapse = "; ")
  ,"). ")
