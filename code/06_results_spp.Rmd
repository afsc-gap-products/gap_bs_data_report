...
fig_st <- "\\@ref(fig:fig-temperature-st-1) and \\@ref(fig:fig-temperature-st-2)"
  ...
  if (report_title == "community") {
    ...
    tab_majorspp_bio = c("tab_majortaxa_pchange_EBS", "tab_majortaxa_pchange_NBS")
  }
...
if (show) {
  if (report_title == "community") {
    ...
    tab_majorspp_bio = c("tab_majortaxa_pchange_EBS")
  }
...
if (show) {
    ...
    tab_majorspp_bio = c("tab_majortaxa_pchange_NBS")
  }
temp <- species_content(
