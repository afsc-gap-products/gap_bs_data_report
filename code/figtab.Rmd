...
table_print <- table_raw %>%
  ...
  theme_flextable_nmfstm(font0 = font0, row_lines = TRUE) %>% 
...
temp1 <- function(table_raw, strat, total) {
  ...
  table_print <- table_print %>%
    ...
    flextable::width(x = ., #j = c(999, strat), 
                     width = 2, unit = "in") %>%
    flextable::width(x = ., j = c("group", "taxon"), 
                     width = 4, unit = "in") %>%    
  ...
  if (i == 1){ # CPUE (WT/HA) and BIOMASS
    ...
    table_print <- table_print %>%
      ...
      flextable::merge_v(x = ., target = "print_name", 
                         j = "print_name", part = "body") %>% 
      flextable::valign(valign = "top") %>%
      theme_flextable_nmfstm(font0 = font0, row_lines = TRUE, pgwidth = full_page_landscape_width)
  }
