...
The `r maxyr` `r SURVEY` bottom trawl surveys were conducted aboard the chartered commercial stern-trawlers `r text_list(cruises_maxyr0$vessel_ital)` (Fig. \@ref(fig:fig-vessels)). `r str0 `  
...
Both vessels use an 83-112 Eastern otter trawl that has been historically used for eastern Bering Sea, Chukchi Sea, and Beaufort Sea surveys (Fig. \@ref(fig:fig-trawl-gear-alt)). Each trawl tow was conducted for 30 minutes at a speed of 2.8–3.2 knots.
