...
str0 <- list_app(nickname = nickname, 
                 ...
                 descr_frag = paste0("lists all fish and invertebrate taxa encountered during the AFSC’s eastern Bering Sea bottom trawl survey."))
sep0 <- "\\pagebreak"
```
...
str0 <- list_app(nickname = nickname, 
                 ...
                 descr_frag = paste0("lists all fish and invertebrate taxa encountered during the AFSC’s northern Bering Sea bottom trawl survey."))
sep0 <- "\\pagebreak"
}
```
