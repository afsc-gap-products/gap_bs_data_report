...
table_raw <- dat_biomass_maxyr %>% 
  ...
  footnote0 <- paste0("Proportion of total estimated biomass, fish and invertebrates combined, for the total survey area = ",NMFSReports::xunits(value = sum(biomass), words = FALSE)," t.")
