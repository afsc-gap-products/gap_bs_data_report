...
nbs_str0 <- ifelse(SRVY == "NEBS", 
                      ...
                      paste0("In addition, the ", maxyr, 
                             ...
                             " time since 2010 that the NBS shelf survey has been completed. The expanded study area covered the entire Bering Sea continental shelf from approximately 20 to 200 m bottom depth to the U.S.-Russia Maritime Boundary between the Alaska Peninsula and the Bering Strait, including Norton Sound."), 
                             # EBS
                             "The study area covered the eastern Bering Sea continental shelf from approximately 20 to 200 m bottom depth; to the U.S.-Russia Maritime Boundary between the Alaska Peninsula; and to the approximate latitude of 62° N).")
...
str0 <- paste0(str01,
                       " than the survey long-term averages of ",
