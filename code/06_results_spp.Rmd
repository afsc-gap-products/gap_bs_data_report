...
spp_plot_idw_20 <- ifelse(is.na(a$plot_idw_coldwarm[1]), FALSE, a$plot_idw_coldwarm[1])
...
```{r}
if (spp_plot_idw_20) {
  fig_dist_above <- paste0("\\@ref(fig:fig-dist-",spp_taxon,"-", spp_file, "-above)")
  fig_dist_below <- paste0("\\@ref(fig:fig-dist-",spp_taxon,"-", spp_file, "-below)")
} 
...
```{r fig-dist-{{jj}}-child, child = paste0(dir_code, "_child_report_figtab.Rmd"), eval=ifelse(spp_plot_idw | spp_plot_idw_20, TRUE, FALSE)}
```
