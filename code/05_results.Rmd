...
Survey teams collected `r str0 ` (Table`r plural_surveys` \@ref(fig:tab-specimen-samples-ebs)`r ifelse(srvy == "NEBS", " and \\@ref(fig:tab-specimen-samples-nbs)", "")`). Other special collections are listed in Table \@ref(tab:tab-special-projects).
...
`r str3`While exhaustive efforts are made to standardize catch processing and data collection, variation in catchability may cause some differences in these results between years [@KotwickiOno2019].
