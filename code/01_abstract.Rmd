...
for (i in 1:length(unique(temp0$SRVY))){
  ...
  # if (sum(temp$nthyr > 1)>(nrow(temp)-1)) { 
    str01 <- paste0(str01, 
                    text_list(
                      paste0("Environmental data, including temperature, salinity, and irradiance, were collected at every survey station. The recent trend of ",
  ...
  if (temp$warmest_rank > (nrow(temp0)-6)) { # is it of the 5 coldest
    str0 <- paste0(str0, 
                   ifelse(temp$warmest_rank != nrow(temp0), 
                          paste0(numbers2words_th(temp$warmest_rank), " "), 
                          ""),
                   "coldest")
  }
  ...
  if (temp$warmest_rank < 6) {  # or is it of the 5 warmest?
    str0 <- paste0(str0, 
                   ifelse(temp$warmest_rank != 1, 
                          paste0(numbers2words_th(nrow(temp0)-temp$warmest_rank), " "), 
                          ""),
                   "warmest")
  }
